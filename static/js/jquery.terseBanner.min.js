...
function(a, b) { "function" == typeof define && define.amd ? define(function() { return b(a, document) }) : "undefined" != typeof exports ? module.exports = b(a, document) : (a.terseBanner = a.terseBanner || {}, a.terseBanner.Banner = b(a, document)) }(window, function(a, b) {
    function c(a, b) { this.$elem = $(a), this.options = b } return c }),
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner", "default-style", "add-element"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("default-style"), require("add-element")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.init = function() { this.$list = this.$elem.children().first(), this.$item = this.$list.children(), this.len = this.$item.length, this.currentIndex = 0, this.activeIndex = 0, this.latestIndex = 0, this.isHovered = !1, this.isAnimated = !1, d.isSupportTouch && (this.options.animation = "slide"); var a = this,
            b = this.$elem,
            c = this.$list,
            e = this.$item,
            f = this.options,
            g = [],
            h = new RegExp("\\?thumb=(.*\\.(gif|jpg|jpeg|png))$"); if (f.init.call(a, b, e), "static" === b.css("position") && b.css("position", "relative"), b.css({ tapHighlightColor: "transparent", userSelect: "none" }), c.width(2 * a.len * 100 + "%").wrap('<div class="tb-list"/>'), f.adaptive && ("none" === b.css("maxWidth") && b.css("maxWidth", "100%"), setTimeout(function() { c.height(b.height()) }, 50), e.each(function() { var a = $(this).children("img"),
                    b = a.attr("src") || a.attr("data-src");
                a.css({ display: "block", maxWidth: "100%" }), a.attr("data-src") && $(this).data("origin", b), $(this).data("thumb", b) })), f.adaptive || e.each(function() { var a = $(this).children("img"),
                    c = a.attr("src") || a.attr("data-src");
                a.attr("data-src") ? $(this).data("origin", c) : $(this).css("backgroundImage", "url(" + c + ")"), $(this).data("thumb", c).height(b.height()), a.remove() }), e.width(b.width()), !(a.len <= 1)) { try { e.each(function() { var b = $(this).data("thumb");
                    g.push(b.match(h) ? b.match(h)[1] : b), a.thumbArr = g }) } catch (i) {} "slide" === f.animation && (d.isSupportTransition && (c.css(d.transformProperty, "translate3d(0, 0, 0)"), c.css("transition", "transform " + f.duration + "ms")), c.css("left", 0), e.css("float", "left").first().show().siblings().hide(), e.first().clone(!0).addClass("first-clone").hide().appendTo(c), e.last().clone(!0).addClass("last-clone").hide().prependTo(c)), "fade" === f.animation && c.before(c.clone(!0).css({ position: "absolute", top: 0, left: 0 })), "fade" !== f.animation && "flash" !== f.animation || e.first().siblings().css("opacity", 0), a.defaultStyle(), a.addElement().arrow() } } }),
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.defaultStyle = function() { var a = ".tb-list,\n.tb-list > *,\n.tb-thumb dl{\n    position: relative;\n    overflow: hidden;\n}\n.tb-list > * > *{\n    position: relative;\n    float: left;\n    min-height: 1px;\n    background-repeat: no-repeat;\n    background-position: center top;\n}\n.tb-list > .touching{\n    -webkit-transition-duration: 0ms !important;\n    transition-duration: 0ms !important;\n}\n.tb-arrow{\n    width: 95%;\n}\n.tb-arrow a{\n    position: absolute;\n    top: 0;\n    cursor: pointer;\n}\n.tb-arrow a.prev{\n    left: 0;\n}\n.tb-arrow a.next{\n    right: 0;\n}\n.tb-arrow a img{\n    display: inline-block;\n    max-height: 100%;\n}\n.tb-btn a{\n    display: inline-block;\n    width: 10px;\n    height: 10px;\n    margin: 0 5px;\n    background-color: #fff;\n    border-radius: 50%;\n    cursor: pointer;\n}\n.tb-btn a.active{\n    background-color: #09c;\n}\n.tb-thumb{\n    position: absolute;\n    bottom: 10px;\n    left: 0;\n    width: 100%;\n    overflow: hidden;\n}\n.tb-thumb a{\n    position: absolute;\n    width: 32px;\n    height: 32px;\n    background-repeat: no-repeat;\n    cursor: pointer;\n}\n.tb-thumb dl dd{\n    position: relative;\n    float: left;\n    margin-left: 0;\n    overflow: hidden;\n    cursor: pointer;\n}\n.tb-thumb dl dd img{\n    position: relative;\n    display: block;\n    width: 100%;\n}\n.tb-loading{\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n}\n.tb-loading img{\n    position: absolute;\n    left: 50%;\n    width: 40px;\n    height: 40px;\n    margin-left: -20px;\n}\n";
...
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.setStyle = function(a) { var b = this.options,
            ...
            l = this.$thumbBox; switch (a) {
            case "arrow":
                "none" === e.css("backgroundImage") && (e.height() || e.height(parseInt(.1 * c.height())), e.filter(".prev").html('<img src="' + d.prevArrow + '">'), e.filter(".next").html('<img src="' + d.nextArrow + '">'), e.find("img").on("dragstart", function() { return !1 })); break;
            case "arrowBoxPos":
                "auto" === f.css("top") && "auto" === f.css("bottom") && f.css({ top: "50%", marginTop: -e.outerHeight() / 2 }), "auto" === f.css("left") && "auto" === f.css("right") && f.css({ left: "50%", marginLeft: -f.width() / 2 }), c.append(f.css("position", "absolute")); break;
            case "btnBoxPos":
                "auto" === h.css("top") && "auto" === h.css("bottom") && h.css("bottom", 10), "auto" === h.css("left") && "auto" === h.css("right") && h.css({ left: "50%", marginLeft: -g.outerWidth(!0) * g.length / 2 }), c.append(h.css("position", "absolute")); break;
            case "thumb":
                i.each(function() { $(this).find("img")[0].complete ? $(this).find("img").css("marginTop", function() { return ($(this).parent().height() - $(this).height()) / 2 }) : $(this).find("img").on("load", function() { $(this).css("marginTop", function() { return ($(this).parent().height() - $(this).height()) / 2 }) }) }), i.css({ width: b.thumb.width, height: b.thumb.height, marginRight: b.thumb.gap }), i.last().css("marginRight", 0); break;
            case "thumbSlideBtn":
                k.css("top", (j.height() - k.height()) / 2); break;
            case "thumbList":
                j.css({ left: 0, width: i.outerWidth(!0) * i.length - b.thumb.gap }); break;
            case "thumbBox":
                var m, n, o = i.outerWidth(!0);
                m = $.isNumeric(b.thumb.visible) ? Math.min(b.thumb.visible, parseInt(c.width() / o)) : parseInt(c.width() / o), n = o * m - b.thumb.gap, l.css({ left: "50%", width: n, height: j.height(), marginLeft: -n / 2 }), j.width() <= l.width() ? k.hide() : (k.filter(".prev").css({ left: b.thumb.gap, backgroundImage: "url(" + d.prevThumbBtn + ")" }), k.filter(".next").css({ right: b.thumb.gap, backgroundImage: "url(" + d.nextThumbBtn + ")" })) } } }),
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner", "set-style", "bind-animation"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("set-style"), require("bind-animation")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.addElement = function() {
        function a() { e.before.call(b, b.$elem, b.$item, b.currentIndex) } var b = this,
            c = this.$elem,
            e = (this.$list, this.options); return { arrow: function() { return !e.arrow || d.isMobile ? void b.addElement().btn() : (c.append('<div class="tb-arrow"><a class="prev"></a><a class="next"></a></div>'), b.$arrowBox = $(".tb-arrow", c), b.$arrow = $(".tb-arrow a", c), b.setStyle("arrow"), b.setStyle("arrowBoxPos"), b.$arrow.on({ click: function() { b.isAnimated || (a(), $(this).hasClass("prev") ? b.currentIndex-- : b.currentIndex++, b.play()) }, selectstart: function() { return !1 } }), void b.addElement().btn()) }, btn: function() { if (!e.btn) return void b.addElement().thumb(); for (var f = 0, g = ""; f < b.len; f++) g += "<a><i></i></a>";
                c.append($('<div class="tb-btn"/>').append(g)), b.$btnBox = $(".tb-btn", c), b.$btn = $(".tb-btn a", c), b.$btn.first().addClass("active"), b.setStyle("btnBoxPos"), "ol" === e.btn && b.$btn.find("i").each(function(a) { $(this).text(a + 1) }), d.isMobile || b.$btn.on(b.options.useHover ? "mouseenter" : "click", function() { b.isAnimated || (a(), b.currentIndex = $(this).index(), b.play()) }), b.addElement().thumb() }, thumb: function() { if (!("object" == typeof e.thumb && parseInt(e.thumb.width) > 0 && parseInt(e.thumb.height) > 0 && parseInt(e.thumb.gap) >= 0)) return void b.bindAnimation(); for (var d, f = 0, g = ""; f < b.len; f++) d = b.thumbArr[f], g += '<dd><img src="' + d + '"></dd>';
                c.append('<div class="tb-thumb"><dl>' + g + '</dl><a class="prev disabled"></a><a class="next"></a></div>'), b.$thumbBox = $(".tb-thumb", c), b.$thumbSlideBtn = $(".tb-thumb a", c), b.$thumbList = $(".tb-thumb dl", c), b.$thumb = $(".tb-thumb dl dd", c), b.setStyle("thumb"), b.setStyle("thumbSlideBtn"), b.setStyle("thumbList"), b.setStyle("thumbBox"), b.$thumb.first().addClass("active"), b.$thumb.on(b.options.useHover ? "mouseenter" : "click", function() { b.isAnimated || (a(), b.currentIndex = $(this).index(), b.play()) }), b.$thumbSlideBtn.on({ click: function() { if (!$(this).hasClass("disabled")) { var a, d, e = b.$thumbBox,
                                f = b.$thumbList,
                                g = b.$thumb,
                                h = parseInt(f.css("left"));
                            a = $.isNumeric(b.options.thumb.visible) ? Math.min(b.options.thumb.visible, parseInt(c.width() / g.outerWidth(!0))) : parseInt(c.width() / g.outerWidth(!0)), d = $(this).hasClass("prev") ? Math.min(h + g.outerWidth(!0) * a, 0) : Math.max(h - g.outerWidth(!0) * a, e.width() - f.width()), b.animation.thumbListSlide(d) } }, selectstart: function() { return !1 } }), b.bindAnimation() } } } }),
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner", "bind-event"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner"), require("bind-event")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.bindAnimation = function() {
        function a() { g.after.call(f, f.$elem, f.$item, f.currentIndex) }

        function b() { f.currentIndex = f.currentIndex === f.len ? 0 : f.currentIndex === -1 ? f.len - 1 : f.currentIndex } var c, e, f = this,
            g = this.options,
            h = this.$elem,
            i = this.$list,
            j = i.children(),
...
function(a, b) { "function" == typeof define && define.amd ? define(["global", "banner"], function(c, d) { return b($, a, document, c, d) }) : "undefined" != typeof exports ? module.exports = b($, a, document, require("global"), require("banner")) : (a.terseBanner = a.terseBanner || {}, b($, a, document, a.terseBanner.Global, a.terseBanner.Banner)) }(window, function(a, b, c, d, e) { e.prototype.lazyload = function() {
        ...
        function b() {
            ...
            i = this.$item,
            j = i.eq(f),
            k = j.data("origin"); if (k)
            if (f) { var l;
                l = "rgba(0, 0, 0, 0)" === g.css("backgroundColor") || "transparent" === g.css("backgroundColor") ? "#fff" : g.css("backgroundColor"); var m = '<div class="tb-loading"><img src="' + d.loadingImage + '"></div>';
                j.append(m), "slide" === e.animation && f === -1 && h.children().first().append(m), $(".tb-loading").css({ background: l, height: g.height() }), $(".tb-loading img").css("top", function() { return (g.height() - $(this).height()) / 2 }), "fade" !== e.animation && "flash" !== e.animation || $(".tb-loading").hide().fadeIn(); var n = new Image;
                f === -1 && (k = i.last().data("origin")), n.src = k, n.complete ? b() : n.onload = b } else b() } }),
function(a, b) {
...
}(window, function(a, b, c, d, e) { e.prototype.play = function() { this.activeIndex = this.currentIndex, this.animation[this.options.animation](), this.lazyload(this.currentIndex) }, e.prototype.setPlayTimer = function() { var a = this,
            b = function() { a.isHovered = !0, clearInterval(a.playTimer) },
            c = function() { a.isHovered = !1, a.isAnimated || a.setPlayTimer() };
        clearInterval(a.playTimer), a.playTimer = setInterval(function() { a.options.before.call(a, a.$elem, a.$item, a.currentIndex), a.currentIndex++, a.play() }, a.options.auto), a.$elem.off("mouseenter"), a.$elem.off("mouseleave"), a.$elem.on({ mouseenter: b, mouseleave: c }) }, e.prototype.activeBtnAndThumb = function() { this.activeIndex = this.currentIndex === this.len ? 0 : this.currentIndex === -1 ? this.len - 1 : this.currentIndex, this.$btn && this.$btn.eq(this.activeIndex).addClass("active").siblings().removeClass("active"), this.$thumb && (this.$thumb.eq(this.activeIndex).addClass("active").siblings().removeClass("active"), this.$thumbSlideBtn.is(":visible") && this.animation.thumbListSlide()) }, e.prototype.switchTo = function() { if (!this.isAnimated) { if ($.isNumeric(arguments[0]) && (arguments[0] < 0 || arguments[0] > this.len)) throw new Error("TerseBanner's index overflow!"); switch (this.options.before.call(this, this.$elem, this.$item, this.currentIndex), arguments[0]) {
                case "prev":
                    this.currentIndex--; break;
                case "next":
                    this.currentIndex++; break;
                default:
                    this.currentIndex = arguments[0] } this.play() } }, $.fn.terseBanner = function(a) { if (d.isLTIE8) throw new Error("terseBanner cannot work under IE8!"); return this.each(function() { var b = $(this).data("terseBanner");
